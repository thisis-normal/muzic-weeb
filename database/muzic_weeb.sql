...
CREATE DATABASE IF NOT EXISTS `muzic_weeb` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `muzic_weeb`;
...
CREATE TABLE IF NOT EXISTS `artists` (
  ...
  `biography` mediumtext COLLATE utf8mb4_general_ci NOT NULL,
...
-- Dumping data for table muzic_weeb.users: ~23 rows (approximately)
INSERT INTO `users` (`id`, `username`, `email`, `password`, `regis_date`, `is_premium`, `role`) VALUES
	...
	(13, 'lmao', 'lmao@lmao.com', '$2y$10$dp/FmFd4XlNDiwzHXo0bE.ixEVR29e3RxhZXDNKvPSIgzLElTGwTK', '2023-10-14 03:26:22', 0, 'admin'),
	...
	(22, 'deropuzu', 'miwi@mailinator.com', '$2y$10$hjL7kDAlCIguKmPDPsnx9O7cMcAVETDzOluiE9MX5eoBJnmvVRXpS', '2023-10-13 14:48:11', 0, 'user'),
	(23, 'vogujoboh', 'wirabuqon@mailinator.com', '$2y$10$i4Hyr14d9uJewfCRr17KmuBhCHavki.2c/lOt0OHXhdcd73RWS4lq', '2023-10-14 03:25:32', 0, 'user'),
	(24, 'bruhh', 'normal2002.dev@gmail.com', '$2y$10$32wCx3uHNjPP6/sgfVb9eOPuy89MCAajnfa9Nd5cLtuHn72ZVm5AC', '2023-10-15 10:24:09', 0, 'user');
