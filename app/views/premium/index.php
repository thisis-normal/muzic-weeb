            ...
            <li class="price-item">
                ...
                <ul class="feature-list">
                    ...
                    <?php if (isUserLoggedIn()) { ?>
                        <?php if ($subscription_plans->id == $_SESSION['license']) : ?>
                            <li><a href="#" data-namepr="<?= $subscription_plans->name ?>"
                                   data-price="$<?= $subscription_plans->price ?>"
                                   data-planid="<?= $subscription_plans->id ?>"
                                   data-period="<?= $subscription_plans->period ?>"
                                   data-planname="<?= $subscription_plans->name ?>" class="btn btn-success">Your current
                                    plan</a></li>
                        <?php else : ?>
                            <li><a href="#" data-namepr="<?= $subscription_plans->name ?>"
                                   data-price="$<?= $subscription_plans->price ?>"
                                   data-planid="<?= $subscription_plans->id ?>"
                                   data-period="<?= $subscription_plans->period ?>"
                                   data-planname="<?= $subscription_plans->name ?>" class="btn btn-success">Buy Now</a>
                            </li>
                        <?php endif; ?>
                    <?php } else { ?>
