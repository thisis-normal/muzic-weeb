    ...
    <main>
                    ...
                    <?php foreach ($data['listArtist'] as $artist) : ?>
                        <tbody>
                            <tr>
                                ...
                                <td><?= $artist->name ?></td>
                                <td class="limit-text"><?= $artist->biography ?></td>
                                <td align="center"><img src="<?= IMGROOT ?>/<?= $artist->image ?>" alt="" width="200px"></td>
                                <td>
                                    <a href="#" class="delete-user" data-delete="<?= $artist->name ?>" data-delete-href="<?= URLROOT ?>/artist-management/delete-artist/?id=<?= $artist->artist_id ?>"><i class='bx bx-trash' style='color:#fb0004'></i></a>
        ...
        <form action="<?= URLROOT ?>/artist-management/create-artist" method="post" enctype="multipart/form-data">
            <div class="form_create formAd popup form_create_artist">
                ...
                <div>
                    <textarea name="biography" id="biography" placeholder="Your bio here!" cols="30" rows="10" required></textarea>
                </div>
                <div class="form-controlGroup-inputWrapper">
                    <label class="form-input form-input--file file_update">
                        <input class="form-input-file" type="file" id="file" name="image" accept="image/*" size="14" required />
        ...
        <form action="<?= URLROOT ?>/artist-management/update-artist" method="post" enctype="multipart/form-data">
            <div class="form_update formAd popup form_update_artist">
                ...
                <br>
                <div>
                    <input type="text" id="artistname" data-field="artistname" name="artist_name" placeholder="Artist's Name">
                </div>
                <div>
                    <textarea name="biography" id="biography" data-field="biography" placeholder="Biography" cols="30" rows="10"></textarea>
                </div>
                <div class="form-controlGroup-inputWrapper">
                    <label class="form-input form-input--file file_update">
